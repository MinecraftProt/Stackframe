...
description = "Stackframe physical-client integration for Fabric"
...
tasks.test {
    ...
    doFirst {
        systemProperty("stackframe.clientArtifact", fabricArtifact.get().asFile.absolutePath)
        systemProperty("stackframe.stackframeLicense", stackframeLicense.absolutePath)
        systemProperty("stackframe.icuLicense", icuLicense.absolutePath)
