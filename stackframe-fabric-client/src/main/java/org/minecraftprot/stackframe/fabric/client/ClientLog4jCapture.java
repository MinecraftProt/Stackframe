 ...
 */
public final class ClientLog4jCapture implements AutoCloseable {
    private static final String APPENDER_NAME = "StackframeClientFailureObserver";
    ...
    private ClientLog4jCapture(LoggerContext context,
    ...
    public static ClientLog4jCapture install(
    ...
    public static ClientLog4jCapture installWithImportance(
            LoggerContext context, BiConsumer<Throwable, Importance> sink) {
        var capture = new ClientLog4jCapture(context, sink);
        try {
